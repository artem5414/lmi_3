...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.function_combo.addItems(["y = 4^x - 10*2^(x-1) - 24", "y = 1 - 1/(1 - sin^(-1)(2x+3π/2))"])
    ...
    def plot_graph(self):
        try:
            ...
            if selected_function == "y = 4^x - 10*2^(x-1) - 24":
                y = 4**x - 10*2**(x-1) - 24
            elif selected_function == "y = 1 - 1/(1 - sin^(-1)(2x+3π/2))":
                y = 1 - 1/(1 - np.arcsin(2*x+3*np.pi/2))
